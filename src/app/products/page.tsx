...
export default function ProductsPage() {
  ...
  const filteredProducts = useMemo(() => {
    ...
    return products.filter((product) => {
      ...
      return (
        productCategory.toLowerCase() === activeTab.toLowerCase()
      );
    });
  }, [products, activeTab]);
    ...
    <main className="min-h-screen overflow-hidden bg-[#EAF8F9] font-quicksand text-[#2D3436]">
      ...
      <section className="relative overflow-hidden px-4 pb-8 pt-28 sm:px-6 lg:px-8 lg:pb-12 lg:pt-36">
        ...
        <div className="relative z-10 mx-auto max-w-7xl text-center">
          ...
          >
            Magical Toys &{" "}
            <span className="text-[#18A6A6]">Kids Furniture</span>
          </motion.h1>
          ...
          >
            Discover our curated collection of safe, ergonomic,
            and purely fun equipment for your little ones.
          </motion.p>
        </div>
      </section>
          ...
          {loadingProducts ? (
            ...
            <div className="rounded-[2rem] bg-white px-6 py-16 text-center shadow-sm">
              ...
              <p className="mx-auto mt-2 max-w-md text-sm leading-6 text-gray-500">
                ...
                category. Please try another category.
              </p>
