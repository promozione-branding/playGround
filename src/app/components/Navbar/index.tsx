...
const mobileNavLinks = [
  {
    ...
    label: "Home",
    icon: Home,
    color: "bg-[#62C4D2]/15 text-[#62C4D2]",
    glow: "#62C4D2",
  },
  {
    href: "/about",
  ...
  },
  {
    ...
    label: "News & Events",
    icon: CalendarDays,
    color: "bg-[#f97316]/15 text-[#f97316]",
    glow: "#f97316",
  },
  {
    href: "/gallery",
    label: "Gallery",
    icon: ImageIcon,
    color: "bg-[#8BC34A]/15 text-[#8BC34A]",
    glow: "#8BC34A",
  },
  {
    href: "/contact",
  ...
  },
  {
    ...
    icon: Handshake,
    color: "bg-[#FFD400]/20 text-[#c9a800]",
    glow: "#c9a800",
  },
];
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          animation:
            "searchSlideIn 0.25s cubic-bezier(0.34,1.56,0.64,1) both",
        }}
      >
        ...
        >
          ...
          <div className="max-w-[1400px] w-full mx-auto flex items-center justify-between gap-4">
            ...
            <div className="hidden xl:flex items-center gap-6">
              ...
              {desktopNav.map((item) => (
                <div
                  key={item.label}
                  className="relative group py-2 px-2"
                >
                  ...
                  {item.children && (
                    <div
                      className="absolute left-1/2 -translate-x-1/2 top-full pt-3 w-52 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-40"
                      style={{
                        transitionProperty:
          ...
          {isMobileMenuOpen && (
            <div
              ...
              style={{
                animation:
                  "drawerSlideIn 0.3s cubic-bezier(0.34,1.2,0.64,1) both",
              }}
            >
              ...
              <div className="bg-white border-t border-[#62C4D2]/20 shadow-xl shadow-black/15">
                ...
                <div className="px-4 sm:px-5 pt-5 pb-6 space-y-4">
                        ...
                        return (
                          ...
                          >
                            ...
                            <div
                              ...
                              style={{
                                boxShadow: `0 0 12px ${link.glow}30`,
                              }}
                            >
                              <Icon
                                className="w-4 h-4"
                            ...
                            <span className="font-extrabold text-[#1a2744] text-sm leading-tight">
                              {link.label}
                            </span>
                  ...
                  <div
                    ...
                    style={{
                      animation:
                        "fadeSlideUp 0.3s 0.24s ease both",
                    }}
                  >
                  ...
                  <a
                    ...
                    style={{
                      animation:
                        "fadeSlideUp 0.3s 0.28s ease both",
                    }}
                  >
                  ...
                  <div
                    ...
                    style={{
                      animation:
                        "fadeSlideUp 0.3s 0.32s ease both",
                    }}
                  >
