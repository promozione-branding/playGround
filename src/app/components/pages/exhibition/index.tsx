...
const HIGHLIGHTS_DATA: HighlightItem[] = [
  ...
  },
  {
    ...
    desc: "Daily meet-and-greets with beloved cartoon characters and superhero mascots.",
  },
  {
    title: "Educational Workshops",
    desc: "Fun, STEM-focused building sessions led by professional toy designers and educators.",
  },
  {
    title: "Safe & Accessible",
    desc: "Wide, stroller-friendly aisles, soft-play floors, and dedicated quiet zones for sensory breaks.",
  },
  {
    title: "Exclusive Toy Launches",
    desc: "Be the first to see and play with unreleased toys from top global brands.",
  },
  {
    title: "Live Magic & Shows",
    desc: "A central stage featuring daily magic acts, puppet shows, and interactive storytelling.",
  },
  {
    title: "Giant Brick Pits",
    desc: "Dive into massive pools filled with building blocks for endless creative construction.",
  },
  {
    title: "Family Rest Areas",
    desc: "Comfortable seating, cafes, and family facilities located throughout the exhibition floor.",
  },
];
...
const EXHIBITION_ZONES_DATA: ExhibitionZone[] = [
  {
    ...
    size: "2,000 sq.m",
    desc: "A massive arena dedicated entirely to interlocking bricks and endless imagination.",
  },
  {
    name: "Sci-Fi Space Station",
    size: "1,500 sq.m",
    desc: "Glow-in-the-dark galaxy featuring laser toys, robots, and spaceship models.",
  },
  {
    name: "Dollhouse Village",
    size: "1,200 sq.m",
    desc: "Life-sized dollhouses, fashion dressing rooms, and miniature worlds.",
  },
  {
    name: "Arcade & Tech Alley",
    size: "1,800 sq.m",
    desc: "The latest in kid-friendly video games, AR experiences, and coding robots.",
  },
  {
    name: "Toddler Soft Play",
    size: "800 sq.m",
    desc: "A safe, padded wonderland designed specifically for children ages 0-3.",
  },
  {
    name: "Board Game Cafe",
    size: "500 sq.m",
    desc: "Sit down as a family and test out the newest tabletop and board games.",
  },
];
...
const DAILY_ACTIVITIES_DATA: DailyActivity[] = [
  ...
  {
    title: "Teddy Bear & Play House Party",
    img: "/about/11.webp",
  },
];
      ...
      <div className="flex flex-col md:flex-row gap-8 md:gap-12 justify-between items-center">
        <div className="w-full md:w-1/2 reveal-up">
          ...
          <p className="text-[#0369a1] text-sm md:text-lg leading-relaxed mb-3 md:mb-4 font-medium">
            Join us for three days of endless fun, creativity, and play. The
            Wonder Play Expo brings together the world's most exciting toy
            brands, educational games, and interactive zones all under one
            massive roof.
          </p>

          <p className="text-[#0369a1] text-sm md:text-lg leading-relaxed font-medium mb-6">
            Whether your child loves building complex robots, diving into giant
            brick pits, or hugging their favorite cartoon characters, there's a
            magical corner waiting for them here.
          </p>

          <button
            type="button"
            onClick={onOpenPopup}
            className="flex items-center justify-center gap-3 md:gap-4 bg-[#0ea5e9] text-white w-full sm:w-auto px-6 py-3.5 md:px-8 md:py-4 rounded-full font-bold md:hover:bg-[#0284c7] md:hover:scale-105 transition-[transform,background-color] duration-200 text-sm md:text-base"
          >
      ...
      <div className="flex flex-col md:flex-row gap-8 md:gap-12">
        <div className="w-full md:w-1/3 md:sticky md:top-28 h-fit reveal-up">
          ...
          <p className="text-[#0369a1] text-sm md:text-lg mb-4 md:mb-6 font-medium">
            Over 10,000 square meters of pure joy. Navigate through our themed
            areas tailored for different age groups.
          </p>

          <Link
            href="/contact"
            className="flex items-center justify-center gap-3 md:gap-4 bg-white text-[#082f49] border-2 border-[#0ea5e9] w-full sm:w-auto px-5 py-2.5 md:px-6 md:py-3 rounded-full font-bold md:hover:bg-[#0ea5e9] md:hover:text-white transition-colors duration-200 text-sm md:text-base"
          >
            Contact Us
          ...
          {EXHIBITION_ZONES_DATA.map((zone, idx) => (
            ...
            >
              <div className="w-full md:w-1/3">
                <h3 className="text-base md:text-xl font-bold text-[#082f49]">
                  {zone.name}
                </h3>
              </div>
              ...
              <div className="w-full md:w-5/12">
                <p className="text-xs md:text-sm text-[#0369a1] font-medium">
                  {zone.desc}
                </p>
              </div>
            </div>
      ...
      <div className="w-full md:w-1/2 px-4 md:px-16 order-1 md:order-2">
        ...
        <div className="flex flex-col gap-2.5 md:gap-4">
          {DAILY_ACTIVITIES_DATA.map((event, idx) => (
            ...
            >
              <h3 className="text-sm md:text-lg font-bold text-[#e0f7fa]">
                {event.title}
              </h3>
      ...
      <div className="bg-white rounded-2xl md:rounded-[3rem] p-6 md:p-14 border border-cyan-100 flex flex-col items-center text-center relative overflow-hidden">
        <div className="max-w-2xl relative z-10">
          ...
          <p className="text-[#0369a1] text-xs md:text-base mb-6 md:mb-8 font-medium">
            Don't miss out on the toy event of the year. Grab your family
            passes today for a weekend of unforgettable memories.
          </p>
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-3">
            <button
              type="button"
              onClick={onOpenPopup}
              className="bg-[#0ea5e9] text-white w-full sm:w-auto px-6 py-3.5 md:px-8 md:py-4 rounded-full font-bold md:hover:bg-[#0284c7] md:hover:scale-105 transition-[transform,background-color] duration-200 text-sm md:text-base flex items-center justify-center gap-2"
            >
              <Ticket className="w-5 h-5" />
              Buy Family Pass
            </button>
