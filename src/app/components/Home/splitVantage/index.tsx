...
const projects: Project[] = [
  {
    ...
    badgeColor:
      "bg-[#FFE66D] text-[#2D3436] border-2 border-[#2D3436]",
    btnColor:
      "bg-[#FFE66D] text-[#2D3436] hover:bg-[#f5dc5f]",
...

  {
    ...
    badgeColor:
      "bg-[#4ECDC4] text-[#2D3436] border-2 border-[#2D3436]",
    btnColor:
      "bg-[#4ECDC4] text-[#2D3436] hover:bg-[#3dbcb3]",
...

  {
    ...
    badgeColor:
      "bg-[#FF6B6B] text-white border-2 border-[#2D3436]",
    btnColor:
