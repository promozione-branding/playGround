...
const SpecialItemCard: React.FC<{
  item: Product;
  onEnquiry: (product: Product) => void;
}> = ({ item, onEnquiry }) => {
  return (
    <Link
      ...
      className="
        ...
        rounded-2xl
        bg-white
        border border-[#ff3b30]/80
        shadow-sm
        hover:shadow-md
        hover:border-[#00C4B5]/40
        transition-all
        cursor-pointer
        group
      "
