      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 w-full relative z-10">
        ...
        <div className="w-full lg:w-[55%] flex flex-col gap-6 text-white items-start">
          ...
          <div className="flex flex-wrap gap-4 mt-2">
            <button className="bg-[#0093D3] hover:bg-[#007bb3] text-white text-xs sm:text-sm font-black tracking-wider px-6 py-3.5 rounded-full uppercase border-2 border-white cursor-pointer transition-colors active:scale-95">
              Explore Products
            </button>
            <button className="bg-[#FFE66D] hover:bg-[#e6cf5c] text-black text-xs sm:text-sm font-black tracking-wider px-6 py-3.5 rounded-full uppercase border-2 border-white cursor-pointer transition-colors active:scale-95">
              Let’s Work Together
            </button>
          </div>
